...
export function TemperatureChart({ data, lang = "en" }: Props) {
  const chartData = data.slice(-30);
  const labels = {
    en: { title: "Temperature", points: "points" },
    fr: { title: "Température", points: "points" },
    ar: { title: "درجة الحرارة", points: "نقطة" },
  } as const;
  const t = labels[lang];
